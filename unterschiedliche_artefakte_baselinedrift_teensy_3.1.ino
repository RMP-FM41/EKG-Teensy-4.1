...
void loop() {
  ...
  int noiseLevel = 0; // "hier 0, weil reiner baselinedrift
				
  
  // --- Parameter für Baseline Drift ---
  float frequenz50 = 50;       	// 50 Hz 
  float amplitude50 = 0;   	// hier 0 weil nur baselinedrift
  ...
  // --- 3. Brummen berechnen ---
  float cleanSine50 = offset + amplitude50 * sin(2 * PI * frequenz50 * t);


  // --- 4. alle Signale addieren ---
  int combinedSignal = (int)cleanSine + noise + cleanSine50;
