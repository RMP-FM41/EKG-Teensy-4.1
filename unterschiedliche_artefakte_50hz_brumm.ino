...
void loop() {
  ...
  // --- Parameter für 50 Hz brummen ---
  float frequenz = 50;       	// 50Hz Hz 
  float amplitude = 250;   	// peak-to-peak der Sinuswelle (also insgesamt 2x 250); hier 0
  ...
  int noiseLevel = 0; // "Amplitude" (1x 150) 
